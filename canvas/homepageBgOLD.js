...
function homepageBg(params) {
    ...
    function stopScriptExecution() {
        stopAnimation = true;
        cancelAnimationFrame(renderFunction);
    }

    function initialize(canvas, percentage, ) {
        ...
        renderFunction = function render() {
            ...
            renderFunction = requestAnimationFrame(render);
        };
    ...
    // Call initialize function on initial load
    initialize();
}
